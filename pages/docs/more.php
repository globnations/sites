			...
			<div class="row">
				<div class="col-md-4">
					<ul class="list-group text-center">
						<li class="list-group-item"><a href="<?php echo $website['info']['langs']['protocol'].'://'.$website['info']['site']['default-url'].'/'.$trad_docs['wiki']['more']['mail']['url']; ?>">/<?php echo $trad_docs['wiki']['more']['mail']['title']; ?></a></li>
					</ul>
				</div>
				<div class="col-md-4">
					<ul class="list-group text-center">
						<li class="list-group-item"><a href="<?php echo $website['info']['langs']['protocol'].'://'.$website['info']['site']['default-url'].'/'.$trad_docs['wiki']['more']['server-channel']['url']; ?>">/<?php echo $trad_docs['wiki']['more']['server-channel']['title']; ?></a></li>
				...
				<div class="col-md-4">
					<ul class="list-group text-center">
						<a href="<?php echo $website['info']['langs']['protocol'].'://'.$website['info']['site']['default-url'].'/'.$trad_docs['wiki']['more']['love']['url']; ?>">/<?php echo $trad_docs['wiki']['more']['love']['title']; ?></a></li>
					</ul>
