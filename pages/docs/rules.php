    ...
    <div class="container">
      <div class="row">
		<div class="col-md-9 col-lg-9">
			<p class="text-center">
				<?php echo $trad_docs['wiki']['rules']['contents']['1']; ?><br>
				<?php echo $trad_docs['wiki']['rules']['contents']['2']; ?><br>
				<?php echo $trad_docs['wiki']['rules']['contents']['3']; ?><br>
				<?php echo $trad_docs['wiki']['rules']['contents']['4']; ?><br>
				<?php echo $trad_docs['wiki']['rules']['contents']['5']; ?><br>
				<?php echo $trad_docs['wiki']['rules']['contents']['6']; ?><br>
				<?php echo $trad_docs['wiki']['rules']['contents']['7']; ?><br>
				<?php echo $trad_docs['wiki']['rules']['contents']['8']; ?><br>
				<?php echo $trad_docs['wiki']['rules']['contents']['9']; ?><br>
				<?php echo $trad_docs['wiki']['rules']['contents']['10']; ?><br>
			</p>
 		</div>
