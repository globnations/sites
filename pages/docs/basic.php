			...
			<div class="row">
				<div class="col-md-4">
					<ul class="list-group text-center">
						<li class="list-group-item"><a href="<?php echo $website['info']['langs']['protocol'].'://'.$trad_docs['wiki']['basic']['contents']['url']['1']; ?>" target="_blank"><?php echo $trad_docs['wiki']['basic']['contents']['title']['1']; ?></a></li>
						<li class="list-group-item"><a href="<?php echo $website['info']['langs']['protocol'].'://'.$trad_docs['wiki']['basic']['contents']['url']['2']; ?>" target="_blank"><?php echo $trad_docs['wiki']['basic']['contents']['title']['2']; ?></a></li>
						<li class="list-group-item"><a href="<?php echo $website['info']['langs']['protocol'].'://'.$trad_docs['wiki']['basic']['contents']['url']['3']; ?>" target="_blank"><?php echo $trad_docs['wiki']['basic']['contents']['title']['3']; ?></a></li>
					</ul>
				</div>
				<div class="col-md-4">
					<ul class="list-group text-center">
						<li class="list-group-item"><a href="<?php echo $website['info']['langs']['protocol'].'://'.$trad_docs['wiki']['basic']['contents']['url']['4']; ?>" target="_blank"><?php echo $trad_docs['wiki']['basic']['contents']['title']['4']; ?></a></li>
						<li class="list-group-item"><a href="<?php echo $website['info']['langs']['protocol'].'://'.$trad_docs['wiki']['basic']['contents']['url']['5']; ?>" target="_blank"><?php echo $trad_docs['wiki']['basic']['contents']['title']['5']; ?></a></li>
						<li class="list-group-item"><a href="<?php echo $website['info']['langs']['protocol'].'://'.$trad_docs['wiki']['basic']['contents']['url']['6']; ?>" target="_blank"><?php echo $trad_docs['wiki']['basic']['contents']['title']['6']; ?></a></li>
				...
				<div class="col-md-4">
					<ul class="list-group text-center">
						<li class="list-group-item"><a href="<?php echo $website['info']['langs']['protocol'].'://'.$trad_docs['wiki']['basic']['contents']['url']['7']; ?>" target="_blank"><?php echo $trad_docs['wiki']['basic']['contents']['title']['7']; ?></a></li>
						<li class="list-group-item"><a href="<?php echo $website['info']['langs']['protocol'].'://'.$trad_docs['wiki']['basic']['contents']['url']['8']; ?>" target="_blank"><?php echo $trad_docs['wiki']['basic']['contents']['title']['8']; ?></a></li>
					</ul>
