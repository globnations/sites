    ...
    <div class="container">
      <div class="row">
		<div class="col-md-9 col-lg-9">
			<p>
				<?php echo $trad_docs['wiki']['more']['server-channel']['contents']['command']; ?><br><br>
				<?php echo $trad_docs['wiki']['more']['server-channel']['contents']['description']['1']; ?><br>
				<?php echo $trad_docs['wiki']['more']['server-channel']['contents']['description']['2']; ?><br>
				<?php echo $trad_docs['wiki']['more']['server-channel']['contents']['description']['3']; ?><br>
				<?php echo $trad_docs['wiki']['more']['server-channel']['contents']['description']['4']; ?><br>
				<?php echo $trad_docs['wiki']['more']['server-channel']['contents']['description']['5']; ?><br>
				<?php echo $trad_docs['wiki']['more']['server-channel']['contents']['description']['6']; ?><br>
				<?php echo $trad_docs['wiki']['more']['server-channel']['contents']['description']['7']; ?><br>
			</p>
 		</div>
